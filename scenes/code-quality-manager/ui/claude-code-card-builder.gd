# Code Quality Manager - Claude Code Card UI Builder
...
func create_card(controls: Dictionary) -> VBoxContainer:
	var card = CollapsibleCard.new("Claude Code Integration", "code_quality/ui/claude_collapsed")
